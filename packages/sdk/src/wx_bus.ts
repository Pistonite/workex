 ...
 */
export interface WxProtocolConfig {
 ...
 */
export interface WxProtocolBindConfig<TSender> {
 ...
 */
export interface WxProtocolBoundSender {
...
export interface WxCreateBusOutput<TConfig extends WxProtocolConfig> {
